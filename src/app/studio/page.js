...
const MODELS = [
  // VIDEO
  { id:"seedance2",    cat:"video", name:"Seedance 2.0",     sub:"BytePlus · até 15s",  desc:{pt:"Movimento fluido cinematográfico, realismo premium, melhor para narrativa",en:"Fluid cinematic motion, premium realism, best for narrative"},  durs:[5,10,15], max:"15s", res:"480p–1080p", ref:"Texto+Imagem", featured:true,  status:"live",  costPerSec:1   },
  { id:"kling3",       cat:"video", name:"Kling 3.0",        sub:"Kuaishou · áudio nativo", desc:{pt:"Pessoas, expressões faciais, movimento natural, áudio sincronizado",en:"People, facial expressions, natural motion, synced audio"},          durs:[5,10],    max:"10s", res:"720p–1080p", ref:"Texto+Imagem", featured:true,  status:"live",  costPerSec:1.2 },
  { id:"veo3",         cat:"video", name:"Veo 3",            sub:"Google · 4K+áudio",   desc:{pt:"4K fotorrealista, áudio nativo, melhor qualidade disponível",en:"4K photorealistic, native audio, highest quality available"},               durs:[5,8],     max:"8s",  res:"1080p–4K",  ref:"Texto+Imagem", featured:true,  status:"live",  costPerSec:2   },
  { id:"sora2",        cat:"video", name:"Sora 2",           sub:"OpenAI",              desc:{pt:"Física realista, cenas complexas, coerência temporal",en:"Realistic physics, complex scenes, temporal coherence"},                           durs:[5,10,20], max:"20s", res:"720p–1080p", ref:"Texto",       featured:false, status:"live",  costPerSec:1.5 },
  { id:"wan27",        cat:"video", name:"Wan 2.7",          sub:"Alibaba · first/last",desc:{pt:"Controle de frame inicial e final, narrativa dirigida",en:"Start and end frame control, directed narrative"},                                 durs:[5,10],    max:"10s", res:"720p",       ref:"Texto+Imagem", featured:false, status:"live",  costPerSec:1.0 },
  { id:"hailuo",       cat:"video", name:"Hailuo",           sub:"MiniMax · rápido",   desc:{pt:"Geração rápida, bom para iteração, movimento expressivo",en:"Fast generation, good for iteration, expressive motion"},                        durs:[6],       max:"6s",  res:"720p",       ref:"Texto+Imagem", featured:false, status:"live",  costPerSec:0.8 },
  { id:"lipsync",      cat:"video", name:"Lipsync Studio",   sub:"Sincronização labial",desc:{pt:"Sincronização labial perfeita para apresentadores, UGC e avatares",en:"Perfect lip sync for presenters, UGC and avatars"},                    durs:[5,10,30], max:"30s", res:"720p",       ref:"Vídeo+Áudio", featured:false, status:"live",  costPerSec:1.0 },
  // IMAGE
  { id:"fluxpro",      cat:"image", name:"Flux Pro",         sub:"Black Forest Labs",   desc:{pt:"Qualidade editorial máxima, detalhes refinados, estilo consistente",en:"Maximum editorial quality, refined details, consistent style"},        durs:[0], max:"—",   res:"até 4K",    ref:"Texto",       featured:true,  status:"live",  costPerImg:8   },
  { id:"seedream5",    cat:"image", name:"Seedream 5",       sub:"BytePlus",            desc:{pt:"Realismo fotográfico, cores ricas, composição cinematográfica",en:"Photographic realism, rich colors, cinematic composition"},                 durs:[0], max:"—",   res:"até 2K",    ref:"Texto+Imagem", featured:true,  status:"live",  costPerImg:6   },
  { id:"gptimage2",    cat:"image", name:"GPT Image 2",      sub:"OpenAI",              desc:{pt:"Instrução em linguagem natural, edição precisa, texto e gráficos",en:"Natural language instruction, precise editing, text and graphics"},      durs:[0], max:"—",   res:"1024px",    ref:"Texto+Imagem", featured:true,  status:"live",  costPerImg:10  },
  { id:"nanobananapro",cat:"image", name:"Nano Banana Pro",  sub:"Nano · personagens",  desc:{pt:"Consistência de personagens, faces precisas, identidade visual estável",en:"Character consistency, precise faces, stable visual identity"},     durs:[0], max:"—",   res:"720p–1080p",ref:"Texto+Imagem", featured:false, status:"live",  costPerImg:5   },
  { id:"geminiomni",   cat:"image", name:"Gemini Omni",      sub:"Google · multimodal", desc:{pt:"Geração multimodal avançada, contexto longo, análise+criação",en:"Advanced multimodal generation, long context, analysis+creation"},          durs:[0], max:"—",   res:"variável",  ref:"Texto+Imagem", featured:false, status:"live",  costPerImg:7   },
  // AUDIO
  { id:"suno",         cat:"audio", name:"Suno",             sub:"Trilha sonora",       desc:{pt:"Composição musical completa — trilha, jingle, tema para vídeo",en:"Full music composition — score, jingle, video theme"},                     durs:[0], max:"—",   res:"MP3",       ref:"Texto",       featured:true,  status:"live",  costFixed:20   },
  { id:"mmaudio",      cat:"audio", name:"MMAudio",          sub:"SFX sincronizado",    desc:{pt:"Efeitos sonoros sincronizados ao vídeo gerado automaticamente",en:"Sound effects synced to video automatically"},                              durs:[0], max:"—",   res:"MP3",       ref:"Vídeo",       featured:true,  status:"live",  costFixed:15   },
  { id:"elevenlabs",   cat:"audio", name:"ElevenLabs",       sub:"Voz & dublagem",      desc:{pt:"Voz ultra-realista, clonagem de voz, narração e dublagem",en:"Ultra-realistic voice, voice cloning, narration and dubbing"},                  durs:[0], max:"—",   res:"MP3",       ref:"Texto",       featured:true,  status:"live",  costFixed:12   },
];
