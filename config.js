...
window.HSAI_CONFIG = {
  ...
  CLAUDE_API_KEY: '',   // ⚠️ BACKEND ONLY — use ANTHROPIC_API_KEY in Vercel env vars
  OPENAI_API_KEY: '',   // ⚠️ BACKEND ONLY — use OPENAI_API_KEY in Vercel env vars
  GEMINI_API_KEY: '',   // ⚠️ BACKEND ONLY — use GEMINI_API_KEY in Vercel env vars
  GEMINI_MODEL:   'gemini-2.0-flash',
  YOUTUBE_API_KEY: '',  // ⚠️ BACKEND ONLY — use YOUTUBE_API_KEY in Vercel env vars
  ...
  // ── SUPABASE (públicos — anon key apenas) ───────────────────────────────────
