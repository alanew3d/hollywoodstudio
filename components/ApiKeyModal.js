    ...
    <div className={wrapperClass}>
      <div className="w-full max-w-sm bg-[#0a0a0a]/90 backdrop-blur-xl border border-white/10 rounded-xl p-10 shadow-2xl relative">
        ...
        <div className="flex flex-col items-center text-center mb-10">
          <div className="w-14 h-14 bg-[#c9a84c]/5 rounded-2xl flex items-center justify-center border border-[#22d3ee]/10 mb-6 group hover:border-[#22d3ee]/30 transition-colors">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#c9a84c" strokeWidth="1.5" className="group-hover:scale-110 transition-transform">
          ...
          <p className="text-white/40 text-[13px] leading-relaxed px-4">
            {subtitle || (
              <>Cole sua <a href="https://hollywoodstudio.ai" target="_blank" rel="noreferrer" className="text-[#c9a84c] hover:text-[#f0d060] transition-colors">Hollywood Studio</a> API key para começar a criar</>
            )}
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full bg-[#c9a84c] text-black font-medium py-2.5 rounded-md hover:bg-[#e5ff33] hover:scale-[1.02] active:scale-[0.98] transition-all shadow-lg shadow-[#22d3ee]/5"
            suppressHydrationWarning
          >
            Get Started
          </button>
          ...
          <p className="text-center text-[12px] text-white/20 pt-2">
            Precisa de uma key?{' '}
            <a href="https://hollywoodstudio.ai" target="_blank" rel="noreferrer" className="text-white/40 hover:text-[#c9a84c] transition-colors font-medium">
              Criar conta →
            </a>
          </p>
        </form>
